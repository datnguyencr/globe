...
const planetData = {
    moon: {
        description:
            "La Luna es el único satélite natural de la Tierra y la quinta luna más grande del Sistema Solar. Desempeña un papel crucial en las mareas, el clima y la estabilidad del eje terrestre.",
        diameter: "3.474 km",
        averageOrbitalSpeed: "1,022 km/s",
        mass: "7,346 × 10²² kg",
        surfaceGravity: "1,62 m/s²",
        orbitalPeriod: "27,3 días",
        rotationPeriod: "27,3 días",
        surfaceTemperature: "-173°C a 127°C",
        ...
        surfaceComposition: "Roca silicatada, basalto, regolito",
    },
    mars: {
        description:
            "Marte es el cuarto planeta desde el Sol y el segundo más pequeño del Sistema Solar. A menudo llamado el Planeta Rojo.",
        diameter: "6.779 km",
        ...
        surfaceTemperature: "-140°C a 30°C",
        atmosphereComposition: [
            "Dióxido de carbono",
            "Nitrógeno",
            "Argón",
        ...
        surfaceComposition: "Basalto, polvo, minerales ricos en hierro",
    },
    saturn: {
        description:
            "Saturno es el sexto planeta desde el Sol y el segundo más grande del Sistema Solar, conocido por sus anillos.",
        diameter: "120.536 km",
        ...
        atmosphereComposition: ["Hidrógeno", "Helio", "Metano", "Amoníaco"],
        surfaceComposition: "Gas con posible núcleo rocoso",
    },
    earth: {
        description:
            "La Tierra es el tercer planeta desde el Sol y el único cuerpo celeste conocido que alberga vida.",
        diameter: "12.742 km",
        ...
        surfaceTemperature: "-88°C a 58°C",
        atmosphereComposition: [
            "Nitrógeno",
            "Oxígeno",
            "Argón",
        ...
        surfaceComposition: "Roca, agua, suelo, hielo",
    },
    jupiter: {
        description:
        ...
        surfaceComposition: "Gas con posible núcleo de hidrógeno metálico",
    },
    mercury: {
        description:
        ...
        surfaceComposition: "Roca silicatada, núcleo rico en hierro",
    },
    neptune: {
        description:
            "Neptuno es el octavo y más distante planeta del Sol, un gigante helado.",
        diameter: "49.244 km",
        ...
        atmosphereComposition: ["Hidrógeno", "Helio", "Metano"],
        surfaceComposition: "Hielo y gas con posible núcleo rocoso",
    },
    sun: {
        description: "El Sol es la estrella en el centro del Sistema Solar.",
        diameter: "1.391.000 km",
        averageOrbitalSpeed: "220 km/s",
        mass: "1,989 × 10³⁰ kg",
        surfaceGravity: "274 m/s²",
        orbitalPeriod: "225 millones de años",
        rotationPeriod: "24 a 35 días",
        ...
        surfaceComposition: "Plasma de hidrógeno y helio",
    },
    uranus: {
        description:
            "Urano es el séptimo planeta desde el Sol, un gigante helado que rota de lado.",
        diameter: "50.724 km",
        ...
        atmosphereComposition: ["Hidrógeno", "Helio", "Metano"],
        surfaceComposition: "Agua, amoníaco y hielos de metano",
    },
    venus: {
        description:
            "Venus es el segundo planeta desde el Sol, con una atmósfera densa y caliente.",
        diameter: "12.104 km",
        ...
        surfaceComposition: "Llanuras volcánicas",
    },
};

let currentPlanet = "earth";
let storedPolygons = []; // To store downloaded geojson for restoring

// Theme Switcher & Planet Logic
document.getElementById("globe-theme").addEventListener("change", (e) => {
    ...
    // Identify planet from selection text or value
    ...
    else if (text.includes("earth")) newPlanet = "earth"; // Explicit check
    ...
    if (currentPlanet === "earth") {
        ...
        // Remove layers for other planets
        // Save polygons if not saved (though they are in closure scope of fetch, better to access via world.polygonsData() if we hadn't overwritten it,
        // but simpler: we have `countriesGeoJson` in the fetch scope. We need global access or re-fetch.
        // Let's modify the fetch to save to `storedPolygons`.
        world.polygonsData([]);
        world.pointsData([]);
    }
});

// Modify Fetch to save data
fetch(
    "https://raw.githubusercontent.com/vasturiano/globe.gl/master/example/datasets/ne_110m_admin_0_countries.geojson"
)
    .then((res) => res.json())
    .then((countriesGeoJson) => {
        storedPolygons = countriesGeoJson.features; // Save for toggling
        if (currentPlanet === "earth") {
            world.polygonsData(countriesGeoJson.features);
            // ... rest of chain defaults ...
        }
